...
function Write-Theme {
    ...
    # Check the last command state and indicate if failed
    If ($LastCommandFailed) {
        $Prompt += Write-Prompt -Object "$($SL.PromptSymbols.FailedCommandSymbol) " -ForegroundColor $([System.ConsoleColor]::Black) -BackgroundColor $LastBackgroundColor
    }
    else {
    ...
    #check for elevated prompt
    If (Test-Administrator) {
        $Prompt += Write-Prompt -Object "$($SL.PromptSymbols.ElevatedSymbol) " -ForegroundColor $([System.ConsoleColor]::Yellow) -BackgroundColor $LastBackgroundColor
    }

    # Check SystemRoot
    If ($PWD.Path.StartsWith($Env:SystemRoot, "CurrentCultureIgnoreCase")) {
        $Prompt += Write-Prompt -Object "$($SL.PromptSymbols.RootSymbol) " -ForegroundColor $([System.ConsoleColor]::Yellow) -BackgroundColor $LastBackgroundColor
    }
    ...
    $Prompt += Write-Prompt -Object $SL.PromptSymbols.SegmentForwardSymbol -ForegroundColor $LayerBackgroundColor1 -BackgroundColor $SL.Colors.SessionInfoBackgroundColor
    ...
    # $Computer = $SL.CurrentHostname
    # if (Test-NotDefaultUser($User)) {
    #     $Prompt += Write-Prompt -Object (" $User $([char]::ConvertFromUtf32(0x25CF)) $Computer ") -ForegroundColor $LastForegroundColor -BackgroundColor $LastBackgroundColor
    # }
    #
    #
    # if (Test-VirtualEnv) {
    ...
    #
    #     $Prompt += Write-Prompt -Object " $($SL.PromptSymbols.VirtualEnvSymbol) $(Compress-String (Get-VirtualEnvName)) " -ForegroundColor $LastForegroundColor -BackgroundColor $LastBackgroundColor
    #
...
$SL.PromptSymbols.PathSeparator                  = " " + [char]::ConvertFromUtf32(0x203A) + " "
...
$LayerTextColor3 = [System.ConsoleColor]::White
$LayerTextColor4 = [System.ConsoleColor]::White

$LayerBackgroundColor1 = [System.ConsoleColor]::DarkRed
$LayerBackgroundColor2 = [System.ConsoleColor]::DarkYellow
$LayerBackgroundColor3 = [System.ConsoleColor]::DarkGreen
$LayerBackgroundColor4 = [System.ConsoleColor]::DarkBlue
